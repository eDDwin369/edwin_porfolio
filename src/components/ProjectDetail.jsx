...
import appmapTable from '../assets/appmap_table.png';
import paperWireframes from '../assets/paper_wireframes.png';
import digitalWireframes from '../assets/digital_wireframes.png';
import mockupsOverview from '../assets/mockups_overview.png';
...
const projectDetails = {
  ...
  "credroad": {
    ...
    persona: {
      ...
      desc: "Sarah is a recent college graduate starting her first full-time job. She is eager to build a solid credit profile to rent her first apartment and eventually buy a car. However, she feels overwhelmed by the contradictory advice online and wants a clear, safe, and guided path to build her credit score without hidden fees.",
      goals: [
          ...
          <div className="personas-right">
            ...
            <div className="persona-card" style={{ marginTop: 0 }}>
              <div className="persona-card-left">
                <h3 className="persona-quote">"{project.persona.quote}"</h3>
                <p className="text-muted persona-desc">{project.persona.desc}</p>
                ...
                <div className="persona-goals-frustrations">
                  <div className="goals-column">
                    ...
                    <ul className="resp-col text-muted">
                      {project.persona.goals.map((goal, gidx) => (
                        <li key={gidx}>{goal}</li>
                      ))}
                    </ul>
                  </div>
                  <div className="frustrations-column">
                    ...
                    <ul className="resp-col text-muted">
                      {project.persona.frustrations.map((frust, fidx) => (
              ...
              <div className="persona-card-right">
                <div className="persona-avatar-wrapper">
                  <img src={project.persona.img} alt={project.persona.name} className="persona-avatar-img" />
                </div>
                <div className="persona-profile-name">
                  <div className="user-icon-bg">
                    <FiUser size={14} />
                  </div>
                  <h3>{project.persona.name}</h3>
                </div>
                <div className="persona-details-list">
                  <div className="detail-item">
                    <span className="detail-label">Age:</span>
                    <span className="detail-value">{project.persona.age}</span>
                  </div>
                  <div className="detail-item">
                    <span className="detail-label">Education:</span>
                    <span className="detail-value">{project.persona.education}</span>
                  </div>
                  <div className="detail-item">
                    <span className="detail-label">Hometown:</span>
                    <span className="detail-value">{project.persona.hometown}</span>
                  </div>
                </div>
              </div>
            </div>
